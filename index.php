    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <span class="navbar-brand h1" id="Titulo_1">
					<img id="Logo" src="img/logo.png" alt="logo" width="30" height="24" class="d-inline-block align-text-top">
					Libe
                </span>
                ...
                <div id="div__4" class="card shadow-lg border-0 rounded-lg mt-5">
                    <form action="controller_login.php" method="post">
                        <div class="card-header">
                            <h1 class="text-center font-weight-light my-4">Inicio de sesión</h1>
                        </div>
                        <div class="card-body">

                            <div class="form-group">
                                <label for="exampleInputEmail1">Usuario</label>
                                <input id="usuario" type="text" class="form-control" name="usuario" placeholder="Ingrese su nombre" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Contraseña</label>
                                <input id="pas" type="password" class="form-control" name="pas" placeholder="Ingrese su contraseña" required>
                            </div>
							<br>
							<div class="form-group">
