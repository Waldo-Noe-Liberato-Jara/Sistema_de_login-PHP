...
<head>
    ...
    <style>
        *{
        ...
        #terminos[type=checkbox]:checked + #aceptar_condiciones:before {
            background: #41DFFF;
            font-size: 15px;
            color: #41DFFF;
            ...
            <div class="col-lg-7">
                <div id="div__4" class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header">
                        <h1 class="text-center font-weight-light my-4">Registro de Usuario</h1>
                    </div>

                    <div class="card-body">
                        <form action="controller_login.php" method="POST" onSubmit="return ValidandoDatos()">
                            <div class="form-group">
                                <label>Nombre de usuario</label>
                                <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Introduce tú nombre de usuario aquí" required>
                            </div>
                            <div class="form-group">
                                <label>Contraseña de Usuario</label>
                                <input type="password" class="form-control" id="pas" name="pas" placeholder="Introduce tú contraseña aquí" maxlength="30" required>
                            </div>
                            <div class="form-group">
                                <label>Repetir contraseña de Usuario</label>
                                <input type="password" class="form-control" id="pas_dos" name="pas_dos" placeholder="Introduce tú contraseña nuevamente aquí" maxlength="30" required>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" class="form-check-input" id="terminos" name="terminos" required>
                                <label for="terminos" class="form-check-label" id="aceptar_condiciones">Acepto los terminos de servicio</label>
                            </div>
							<div class="form-group">
...
<script src="javascript/text"></script>
<script>
